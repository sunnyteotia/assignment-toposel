...
const registerUser=async(req,res)=>{
    try{
        ...
        const {username,email,password,role,fullname,DOB,country,gender}=req.body;
        ...
        const newlyCreatedUser=new User({username,email,password:hashedPassword,role:role||'user',fullname,DOB,country,gender});
...
module.exports={loginUser, registerUser,changePassword,searchUser};